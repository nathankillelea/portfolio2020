      ...
      <div id={styles.body}>
        <section id={SharedStyles.projectInfoContainer}>
          ...
          <div className={SharedStyles.tagContainer}>
            <a href='https://emmysdoodles.com' className={SharedStyles.projectSourceButton} style={{backgroundColor: 'rgba(244, 219, 155)'}} target='_blank' rel='noopener noreferrer'>
              <h4 style={{fontWeight: '600'}}>Website</h4>
            </a>
            <h4 className={SharedStyles.tagText}><strong style={{color: 'rgba(244, 219, 155)', fontWeight: 600}}>Tech</strong><span style={{fontWeight: 600}}> React, Redux, Firebase, Stripe API</span></h4>
          </div>
        </section>
        <h3 className={SharedStyles.projectDesign}>Design</h3>
        <div className={SharedStyles.projectImageRowContainer}>
          <img src='../../assets/emmys_doodles_1.jpg' className={styles.image} alt="Emmy's Doodles Design" />
        </div>
      </div>
      <ProjectsNav previous='/illini-events' next='/fanchat' />
    </div>
  );
}
